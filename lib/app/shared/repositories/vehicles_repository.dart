...
//  final VehiclesController vehiclesController = VehiclesController();
//  vehiclesController.addVehicle(uuid: item['uuid'], vehicle: item);
////      vehiclesController.updateVehicle(
////          uuid: item['uuid'], prop: 'selected', newValue: true);
  ...
  Future<List<VehicleModel>> getMarinaVehicles() async {
    ...
    List<VehicleModel> vehicleModelList = List<VehicleModel>();

    Map<String, dynamic> vehiclesMap = {};

    for (var item in (response.data['data']['data'] as List)) {
      vehiclesMap[item['uuid']] = item;
